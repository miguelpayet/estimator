...
public class PanelCronograma extends FormComponentPanel<TareaCronograma> {
	...
	public PanelCronograma(String id) {
		super(id);
	}

	public PanelCronograma(String id, IModel<TareaCronograma> model) {
		super(id, model);
	}
